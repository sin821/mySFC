  ...
  <body>
    ...
    <?php include('../modules/alerts.php'); ?>
      ...
      <div class="starter-template">
        <h2>Update TMS3 Flightlist</h2>
        
        <div class="row">
          <div class="col-lg-offset-1 col-lg-10 col-md-12">
          <?php
            $query = "SELECT MAX(tms3flightlist_date) AS lastUpdatedDate FROM tbl_tms3flightlist LIMIT 1";
            ...
            <form id="latency-form" class="form-horizontal" method="POST" action="../php/updateLatencyTMS3.php">

              <hr />

              <div class="form-group">
                <textarea id="input-tms" name="flightList" class="form-control" placeholder="Copy and paste daily flight list from TMS3 here..."></textarea>
              </div>

...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">
          <div class="col-md-7">
            <div class="panel panel-default">
                <div class="panel-heading">Loadsheet for Leased Cessnas (YH-series)</div>
                ...
                <div class="panel-body" id="cessnaLoadsheet">
                    <div class="row">
                      <div class="col-xs-6 load-form-group">
                        ...
                        $query = "SELECT * FROM tbl_aircrafts WHERE aircraft_type='cessna_leased'";
                        ...
                        <small class="text-muted">Looking for YG or YU aircraft? <a href="calculator.php">Click Here.</a></small>
                      </div>
                      <div class="col-xs-6 load-form-group">
                        <label>Fuel:</label>
    ...
    function calculateBalance() {
      ...
      var fuelMoment = Math.round(fuelWeight * 1.18064516);
      ...
      if(takeOffWeight>1156) {
        error += "Takeoff Weight exceeds 1156kg!<br />";
      }
      if(fuel>190) {
    ...
    function calculatePerformance() {
      ...
      switch (tempCategory) {
          case 1: takeoff0 = ((6.5 * temp) + 860 + (pressureAltCorrectionFactor * 8)) * 1.15 * tailWindMargin;
              break;
          case 2: takeoff0 = ((7 * (temp-10)) + 925 + (pressureAltCorrectionFactor * 8.5)) * 1.15 * tailWindMargin;
              break;
          case 3: takeoff0 = ((7.5 * (temp-20)) + 995 + (pressureAltCorrectionFactor * 9.5)) * 1.15 * tailWindMargin;
              break;
          case 4: takeoff0 = ((8 * (temp-30)) + 1070 + (pressureAltCorrectionFactor * 11)) * 1.15 * tailWindMargin;
              break;
      ...
      switch (tempCategory) {
          case 1: takeoff50  = ((11 * temp) + 1465 + (pressureAltCorrectionFactor * 13.5)) * 1.15 * tailWindMargin;
              break;
          case 2: takeoff50  = ((11.5 * (temp-10)) + 1575 + (pressureAltCorrectionFactor * 14.5)) * 1.15 * tailWindMargin;
              break;
          case 3: takeoff50  = ((12 * (temp-20)) + 1690 + (pressureAltCorrectionFactor * 16)) * 1.15 * tailWindMargin;
              break;
          case 4: takeoff50  = ((13.5 * (temp-30)) + 1810 + (pressureAltCorrectionFactor * 18)) * 1.15 * tailWindMargin;
              break;
        ...
        switch (tempCategory) {
          case 1: landing0 = ((2 * temp) + 545 + (pressureAltCorrectionFactor * 2)) * 1.15 * tailWindMargin;
              break;
          case 2: landing0 = ((2 * (temp-10)) + 565 + (pressureAltCorrectionFactor * 2)) * 1.15 * tailWindMargin;
              break;
          case 3: landing0 = ((2 * (temp-20)) + 585 + (pressureAltCorrectionFactor * 2)) * 1.15 * tailWindMargin;
              break;
          case 4: landing0 = ((2 * (temp-30)) + 605 + (pressureAltCorrectionFactor * 2)) * 1.15 * tailWindMargin;
              break;
      ...
      switch (tempCategory) {
          case 1: landing50  = ((3 * temp) + 1290 + (pressureAltCorrectionFactor * 3)) * 1.15 * tailWindMargin;
              break;
          case 2: landing50  = ((3 * (temp-10)) + 1320 + (pressureAltCorrectionFactor * 3)) * 1.15 * tailWindMargin;
              break;
          case 3: landing50  = ((3 * (temp-20)) + 1350 + (pressureAltCorrectionFactor * 3.5)) * 1.15 * tailWindMargin;
              break;
          case 4: landing50  = ((3.5 * (temp-30)) + 1380 + (pressureAltCorrectionFactor * 4)) * 1.15 * tailWindMargin;
              break;
